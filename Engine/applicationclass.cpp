...
bool ApplicationClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_TextString2->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), screenWidth, screenHeight, 32, m_Font, testString2, 10, 50, 1.0f, 0.0f, 0.0f);
	if (!result)
	{
		return false;
	}
